...
describe("ChefSection", () => {
  ...
  it("renders the chef section with chef image and information", () => {
    ...
    expect(chefImage).toHaveAttribute("src", "/images/menu/chef/background.jpg.webp");
  ...
  it("marks LCP loaded when the chef image is loaded", () => {
    ...
    expect(mockPerformanceMeasure).toHaveBeenCalledWith("time-to-lcp", "navigationStart", "lcp-loaded");
