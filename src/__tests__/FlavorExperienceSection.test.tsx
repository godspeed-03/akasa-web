...
describe("FlavorExperienceSection", () => {
  ...
  it("renders the background images", () => {
    ...
    expect(images[0]).toHaveAttribute("src", "/images/home/philosophy/background.jpg.webp");
    expect(images[1]).toHaveAttribute("src", "/images/home/philosophy/drink.jpg.webp");
  });
