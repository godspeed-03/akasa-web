...
2.  **Hero Section**: A `<section>` element with a background image (`/images/menu/a-la-carte/hero/hero.jpg.webp`) and a semi-transparent black overlay. It contains a centered title ("À La Carte Menu") and a brief description.
