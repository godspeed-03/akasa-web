...
2.  **Hero Section**: A `<section>` element with a background image (`/images/menu/bar-bites/hero/hero.jpg.webp`) and a semi-transparent black overlay. It contains a centered title ("Chaat & Bar Bites") and a brief description.
