...
2.  **Hero Section**: A `<section>` element with a background image (`/images/menu/drinks/hero/hero.jpg.webp`) and a semi-transparent black overlay. It contains a centered title ("Drinks Menu") and a brief description.
3.  **Menu Content Section**: Another `<section>` element that houses the main menu content.
    ...
    - _Note_: Unlike food menus, this page does not include a vegetarian/non-vegetarian legend.
