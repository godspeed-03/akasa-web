...
2.  **Hero Section**: A `<section>` element with a background image (`/images/menu/set-lunch/hero/hero.jpg.webp`) and a semi-transparent black overlay. It contains a centered title ("3 Course Set Lunch") and a brief description.
