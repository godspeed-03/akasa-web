...
2.  **Hero Section**: A `<section>` element with a background image (`/images/menu/soul-food-weekends/hero/hero.jpg.webp`) and a semi-transparent black overlay. It contains a centered title ("Soul Food Weekends") and detailed descriptive paragraphs about the culinary journey, unlimited chaat offer, and availability.
