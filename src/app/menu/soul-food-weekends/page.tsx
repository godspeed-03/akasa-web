...
export default function SoulFoodWeekendsMenuPage() {
  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      {/* Hero Section */}
      <section className="w-full bg-[url('/images/menu/soul-food-weekends/hero/hero.jpg.webp')] bg-cover bg-center py-64 relative">
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10 text-center">
          ...
          <p className="text-lg md:text-xl font-montserrat text-white/80 max-w-3xl mx-auto">
            Treat your taste buds to a nostalgic culinary journey with Soul Food Weekends. We bring you heart-warming
            flavors of North India's most beloved dishes like Pindi Chole with Kulcha, Keema Pav, Dal Bhati Choorma,
            Saroson ka Saag & Gosht Bhuna Bheeja & more.
          </p>
