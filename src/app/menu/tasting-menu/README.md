...
2.  **Hero Section**: A `<section>` element with a background image (`/images/menu/tasting-menu/hero/hero.jpg.webp`) and a semi-transparent black overlay. It contains a centered title ("Tasting Menu") and a brief description.
