...
2.  **Hero Section**: A `<section>` element with a background image (`/images/menu/vegan/hero/hero.jpg.webp`) and a semi-transparent black overlay. It contains a centered title ("Vegan Menu") and a brief description.
