...
const SocialIcon = memo(function SocialIcon({ href, children }: { href: string; children: React.ReactNode }) {
  return (
    <a
      href={href}
      target="_blank"
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="flex items-center mb-6 md:mb-0">
            <p className="text-xs sm:text-sm text-white/60 font-montserrat">{"© 2025 Akasa"}</p>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-4 sm:gap-6 mb-6 md:mb-0">
            <Link
              href="/"
              className="text-white/80 hover:text-[#E6C78B] transition-colors text-xs sm:text-sm font-montserrat py-1 px-2 touch-manipulation"
            >
              Home
            </Link>
            <Link
