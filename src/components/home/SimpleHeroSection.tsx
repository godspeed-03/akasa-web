      ...
      <div className="absolute inset-0 w-full h-full overflow-hidden bg-black mobile-only">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="flex flex-col items-center justify-center px-4 text-center">
            <p className="text-white/90 uppercase tracking-widest text-sm mb-4">Experience</p>

            <h1
              className="text-white text-4xl font-playfair italic mb-6"
            ...
            <p className="text-white/80 mb-8 text-sm">Fine Dining at the Heart of Singapore</p>
          </div>
        </div>
      </div>
