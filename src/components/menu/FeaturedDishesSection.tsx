  ...
  const featuredDishes = [
    {
      name: "Galouti Kebab",
      description:
        "Melt-in-your-mouth lamb patties, infused with aromatic spices and pan-seared to perfection—a royal delicacy from the kitchens of Lucknow",
      image: "/images/menu/featured-dishes/galouti.jpg.webp",
      price: "$25",
      category: "Signature",
    },
    {
      ...
      description:
        "Fragrant basmati slow-cooked under a dough-sealed lid, infused with saffron strands and Akasa's secret blend of hand-ground spices—fluffy, rich, and unapologetically indulgent",
      image: "/images/menu/featured-dishes/akasa-e-dum-biryani.jpg.webp",
      price: "$25",
    ...
    },
    {
      name: "Dal-E-Akasa",
      description:
        "Earthy black lentils, patiently simmered over a full day, melting into a buttery symphony that comforts like a memory—and lingers like legend",
      image: "/images/menu/featured-dishes/dal-e-akasa.jpg.webp",
      price: "$22",
      category: "Vegetarian",
    },
    {
      name: "Paronthia Naan",
      description:
        "Flaky, golden naan folded six times over with whispers of saffron and crushed nuts—each bite a soft, buttery echo of ancient feasts",
      image: "/images/menu/featured-dishes/paronthia-naan.jpg.webp",
      price: "$8",
      category: "Signature",
    },
    {
      ...
      description:
        "Tiger prawns, charred to smoky perfection, boldly seasoned with ground masalas and the elusive Sankeshwari chilli—fiery, tender, and primal",
      image: "/images/menu/featured-dishes/tandoori-prawns.jpg.webp",
      price: "$32",
      category: "Seafood",
    },
    {
      ...
      description:
        "Whole white pomfret marinated in a tangy methiyani chilli paste and creamy yogurt, grilled till it crackles—smoky, juicy, and deeply coastal",
      image: "/images/menu/featured-dishes/tandoori-pomfret-kebab.jpg.webp",
      price: "$34",
      category: "Seafood",
    },
  ];
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          {featuredDishes.map((dish, index) => (
            <div key={index} className="group relative dish-card h-full flex flex-col">
              ...
              <div className="relative bg-black/80 backdrop-blur-sm border border-white/5 rounded-lg overflow-hidden transition-all duration-[1000ms] group-hover:shadow-[0_0_25px_rgba(230,199,139,0.2)] flex flex-col h-full">
                ...
                <div className={`${isMobile ? "p-6" : "p-8"} relative flex flex-col flex-grow`}>
                  ...
                  <div className="flex justify-between items-start mb-4 gap-2">
                    <h3
                      className={`${isMobile ? "text-xl" : "text-2xl"} font-playfair text-white group-hover:text-[#E6C78B] transition-colors duration-300 flex-1`}
                    >
                      {dish.name}
                    </h3>
                    <span
                      className={`text-[#E6C78B] font-medium ${isMobile ? "text-base" : "text-lg"} min-w-[45px] text-right whitespace-nowrap`}
                    >
                      {dish.price}
                    </span>
                  </div>
                    ...
                    <a href="https://akasa.oddle.me/en_SG/" target="_blank" rel="noopener noreferrer">
                      {isMobile ? (
                        ...
                        <button className="w-full inline-flex items-center justify-center rounded-full text-sm font-montserrat font-medium tracking-wider bg-[#1A2A3A] text-white px-4 py-2 shadow-md">
                          <span className="text-center font-medium tracking-wide w-full">Order Now</span>
                        </button>
                      ) : (
