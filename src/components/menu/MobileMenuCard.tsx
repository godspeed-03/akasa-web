 ...
 */
const MobileMenuCard = memo(function MobileMenuCard({ menu, isActive, onClick }: MobileMenuCardProps) {
  return (
    <div key={menu.id} className="group cursor-pointer mx-auto w-full max-w-sm" onClick={onClick}>
      <div
      ...
      >
        ...
        <div className="relative overflow-hidden border border-[#E6C78B]/30 rounded-lg shadow-lg shadow-black/30 bg-black/80 backdrop-blur-sm">
          ...
          <div className="p-6">
            ...
            <p className="text-white/80 text-sm mb-5 line-clamp-3 text-center">{menu.description}</p>
