  ...
  return (
    <section className="h-[80vh] w-full relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <HydrationSafeImage
          src="/images/reservations/hero/hero.jpg.webp"
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10 h-full flex flex-col items-center justify-center">
        <div className="max-w-3xl mx-auto text-center">
          {/* Decorative elements */}
          <div
            className={`mb-6 opacity-0 ${isVisible ? "animate-fadeIn" : ""}`}
          ...
          >
            Secure your dining experience at Akasa. We look forward to serving you the finest Indian cuisine in an
            elegant atmosphere.
          </p>
