...
export const CHEF_INFO = {
   ...
   */
  achievements: ["Taste Guru", "Curry Architect", "Culinary Trendsetter"],
};
 ...
 */
export const SPICE_SVG_PATH =
  "M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z M12 2V22M2 12H22M4.93 4.93L19.07 19.07M19.07 4.93L4.93 19.07";
